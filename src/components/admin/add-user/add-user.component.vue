                ...
                <v-row>
                    <v-col>
                        <div class="text-field-container">
                            <v-text-field v-model="lastNameUserValue" class="" label="Nom Utilisateur" variant="outlined"
                                :rules="[rules.required]" />
                        </div>
                    </v-col>
                    <v-col>
                        <div class="text-field-container">
                            <v-text-field v-model="firstNameUserValue" class="" label="Prénom Utilisateur"
                                variant="outlined" :rules="[rules.required]" />
                        </div>
                    </v-col>
                    <v-col>
                        <div class="text-field-container">
                            <v-text-field v-model="emailUserValue" class="" label="Mail Utilisateur" variant="outlined"
                                :rules="[rules.required, rules.formatEmail]" />
                        </div>
                    </v-col>
                    <v-col>
                        <v-btn icon="mdi-trash-can-outline" color="red" variant="plain" @click="deleteComponent()" />
                        <v-btn icon="mdi-check-circle-outline" color="green" variant="plain"
