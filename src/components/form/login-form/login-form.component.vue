<template>
    ...
    <v-layout class="wrap container-wrap">
      <div class="login-form-container">
        <v-card>
          ...
          <p v-if="errorAuthentification" class="error_authentification">L'adresse mail ou le mot de passe n'est pas correct</p>
          <p v-if="errorReinitPassword" class="error_authentification">{{errorReinitPassword}}</p>
  ...
  <boxDialogueSendEmail v-if="isDisplaySendMail" @resend-mail = "forgotPassword()" @close-dialog="isDisplaySendMail = false"></boxDialogueSendEmail>
</template>
